      ...
      <div className={styles.detailContainer}>
            ...
            {!collapsedSections.materials && (
              <div className={styles.accordionContent}>
                <div className={styles.materialList}>
                  {(product.materials ?? []).map((material: { name: string; value: string }, index: number) => (
        ...
        <div className={styles.detailCenter}>
          <div className={styles.mainImage}>
            <Image
              src={(product.images ?? [product.image])[mainImage]}
              alt={product.name}
              fill
          ...
          <div className={styles.variantSection}>
            <div className={styles.variantLabel}>
              ...
              <span className={styles.variantValue}>
                {(product.colors ?? []).find((c: { name: string; value: string }) => c.value === selectedColor)?.name || 'Charcoal'}
              </span>
            </div>
