...
export default function BudgetPage() {
  ...
  const goNext = () => {
    ...
    if (currentStep < 4) {
      ...
      // Save plan - convert to BudgetPlan shape (seating, storage, lighting, bed_or_desk, rug_decor, buffer)
      ...
      const plan = {
        ...
        tradeoffStatement: 'Your budget is allocated across categories. You can adjust in the room planner.',
