...
import type { TaskCard, FeedbackMessage, MessageType } from '@/types/chat';
...
export default function ChatbotPage() {
  ...
  // Demo responses that cycle through different feature showcases (stable reference for useCallback)
  const DEMO_RESPONSES = useMemo((): DemoResponseItem[] => [
    {
      type: 'greeting',
      content: 'Good morning!',
    },
    ...
    },
    {
      ...
      ] as PreferenceExtraction[],
      updateProjectInfo: (prev: ProjectInfo) => ({ ...prev, roomType: 'living room' }),
    },
    {
      type: 'text',
      ...
      updateProjectInfo: (prev: ProjectInfo) => ({ ...prev, designStyle: 'modern minimalist' }),
    },
    {
      type: 'text',
      ...
      updateProjectInfo: (prev: ProjectInfo) => ({ ...prev, budgetRange: '$15,000' }),
    },
    {
      type: 'taskCard',
      taskCard: {
    ...
    },
    {
      ...
      updateProjectInfo: (prev: ProjectInfo) => ({ ...prev, colorTheme: ['neutral', 'warm tones'] }),
    },
    {
      type: 'feedback',
      feedback: {
    ...
    },
    {
      ...
      updateProjectInfo: (prev: ProjectInfo) => ({ 
        ...prev, 
